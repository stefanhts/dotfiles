...
return require('packer').startup(function(use)
	...
	use {
	  'VonHeikemen/lsp-zero.nvim', branch = 'v2.x', requires =
	  {
	    ...
	    -- Autocompletion {'hrsh7th/nvim-cmp'},     -- Required
	    {'hrsh7th/cmp-nvim-lsp'}, -- Required {'L3MON4D3/LuaSnip'},
	    -- Required
	  }
	}
      ...
      use {
	  'nvim-telescope/telescope.nvim', tag = '0.1.0', -- or
	...
	'nvim-tree/nvim-web-devicons', opt = true } }
	  ...
	  "folke/trouble.nvim", config = function()
		  ...
		  icons = false, -- your configuration comes here
      ...
      use("theprimeagen/refactoring.nvim") use("mbbill/undotree")
